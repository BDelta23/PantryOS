...
- [ ] Phase 6 — barcode, receipts, purchases, and price history (in progress; barcode mapping and known-code add-lot workflow added)
...
- Advanced product/location/recipe UI, receipt ingestion, camera barcode feature detection, and price history are still incomplete.
